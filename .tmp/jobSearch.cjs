...
var jobSearch_exports = {};
__export(jobSearch_exports, {
  collectJobDetailCandidates: () => collectJobDetailCandidates,
  collectMonsterEmbeddedCandidates: () => collectMonsterEmbeddedCandidates,
  isAppliedJobText: () => isAppliedJobText,
  isCurrentPageAppliedJob: () => isCurrentPageAppliedJob,
  isLikelyJobDetailUrl: () => isLikelyJobDetailUrl,
  isStrongAppliedJobText: () => isStrongAppliedJobText,
  looksLikeTechnicalRoleTitle: () => looksLikeTechnicalRoleTitle,
  pickRelevantJobUrls: () => pickRelevantJobUrls,
  shouldFinishJobResultScan: () => shouldFinishJobResultScan
});
module.exports = __toCommonJS(jobSearch_exports);
...
module.exports.__debug = { shouldSkipDiceTitleCandidate, buildDiceCandidateMetadata, extractDiceSemanticStatusTokens, addJobCandidate, isAppliedJobText };

module.exports.__debugCollectors = { collectDiceListItemCandidates, collectDiceSearchCardCandidates };

module.exports.__debugContext = { buildDiceCandidateContextText };
